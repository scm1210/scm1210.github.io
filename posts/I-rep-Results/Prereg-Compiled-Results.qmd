...
ggplot(aes(x = estimate, y = factor(outcome),
  ...
  geom_vline(xintercept = 0, linetype = "dashed") +
  annotate("text", x = -0.20, y = max_y, label = "← Bad/Unable", hjust = 0, size = 5, fontface = "italic") +
  annotate("text", x =  0.18, y = max_y, label = "Good/Able →", hjust = 1, size = 5, fontface = "italic") +
  theme_minimal() +
  theme(
