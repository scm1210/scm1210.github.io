...
df = read_csv('/Users/sm9518/Downloads/Talkspace_MADS_Exp_TEST_Words.csv')
...
control = read_csv('/Users/sm9518/Downloads/Talkspace_MADS_Exp_TEST_Words.csv')

control = control |> 
  dplyr::rename(room_id = 1) |> #rename the first column to the room_id
  filter(bin < 5) |> 
  select(1,2,bin,a_good,a_bad,a_able,a_unable,and_good,and_bad,and_able,and_unable)


### merge the two dataframes
df = df |>
  left_join(control, by = c("room_id", "bin")) 
