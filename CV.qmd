...
**Mesquiti, S. & Nook, E.C.** (in Press.). *Large Language Models in. Mental Health Treatment and Research.* *Annual Reviews BioMedical Data Science.* [DOI](https://doi.org/10.31234/osf.io/jvf2z_v1)
...
**Muzekari, B., Cooper, N., Resnick, A., Paul, A. M., Torres-Grillo, O. E., Andrews, M. E., Mattan, B., Scholz, C., Johnson, D., Carreras-Tartak, J., Cakar, M. E., Hao, S., Zhou, E., Beard, E., Mesquiti, S., Sayed, F., Fichman, M. A., Lydon-Staley, D. M., Barnett, I. J., … Falk, E. B.** (2025). *Naturalistic Tobacco Retail Exposure and Smoking Outcomes in Adults Who Smoke Cigarettes Daily.* *JAMA Network Open.* [DOI](https://doi:10.1001/jamanetworkopen.2025.30132)
...
-   **Mesquiti, S., Nook, E. C.** (in prep.) *Investigating Racial Sensitivity in Language-Based Assessments of Mental Health.*
...
-   **2026**: Princeton University Data Driven Social Science Graduate Fellowship
...
Transformer-based language models, semantic projection methods, topic modeling, sentiment analysis, dictionary-based methods, language-based assessment of mental health, large language models.

**Machine Learning & Statistical Methods**\
Supervised machine learning, multilevel modeling, moderation & mediation analysis, time-series analysis, item response theory, general linear models.

**Programming & Data Science**\
R (proficient), Python (moderate), SQL(moderate), Bash, reproducible research (Quarto/R Markdown), large-scale data pipeline development.

**Research Methods**\
Longitudinal & clinical text data, large-scale social media data, mixed-method study design, within- and between-person designs, open science practices.
