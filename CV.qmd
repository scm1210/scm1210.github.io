...
Sahi, R. S., Mesquiti, S., Hull, T. D., Vine, V., & Nook, E. C. (under review). Affect labeling is linked with better mental health in psychotherapeutic conversations. *Nature Mental Health*.
...
Transformer-based language models, semantic projection & embedding-based measurement, topic modeling (LDA), dictionary-based methods (DLATK), language-based mental health assessment.

**Machine Learning & Statistical Methods**\
Supervised learning & fine-tuning (LoRA/PEFT), ridge regression, mixed-effects/multilevel modeling, moderation & mediation analysis.
